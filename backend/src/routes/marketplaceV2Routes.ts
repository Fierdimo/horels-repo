  ...
  try {
    ...
    const propertiesData = await Promise.all(properties.map(async (property: any) => {
      ...
      return {
        ...
        latitude: property.latitude != null ? parseFloat(String(property.latitude)) : null,
        longitude: property.longitude != null ? parseFloat(String(property.longitude)) : null,
  ...
  try {
    ...
    return res.json({
      ...
      data: {
        ...
        latitude: propertyData.latitude != null ? parseFloat(String(propertyData.latitude)) : null,
        longitude: propertyData.longitude != null ? parseFloat(String(propertyData.longitude)) : null,
